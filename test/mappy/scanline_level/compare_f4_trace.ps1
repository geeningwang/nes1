# compare_f4_trace.ps1
# Compare nes1 and FCEUX per-scanline / per-write traces for Frame 4
...
$OutDir     = 'C:\Work\nes1\test\mappy_out'
$Nes1Trace  = "$OutDir\nes1_sl_f4.txt"
$FceuxTrace = "$OutDir\fceux_sl_f4.txt"
$OutHtml    = "$OutDir\f4_compare.html"
$TargetFrame = 4
...
if (-not (Test-Path $FceuxTrace)) {
    Write-Warning "FCEUX trace not found: $FceuxTrace -- run mappy_f4_trace.lua in FCEUX first."
}
...
$null = $sb.Append('<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><title>Frame 4 Trace Compare - Mappy</title>')
...
$null = $sb.Append("<div class='page-hdr'><h1>Frame 4 Trace Compare &mdash; Mappy (Japan)</h1>")
